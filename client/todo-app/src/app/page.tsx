...
export default function Dashboard (){
    ...
    return (
        <section className="min-h-screen w-full flex justify-center">
            <div className="bg-[url(/img/bg-mobile-light.jpg)] w-full px-4 bg-no-repeat bg-contain dark:bg-[url(/img/bg-mobile-dark.jpg)] dark:bg-slate-950">
                <div className="w-full flex justify-between items-center pt-22 pb-14 px-5">
