                ...
                <div className="max-w-[750px] w-full">
                    ...
                    <div className="space-y-10">
                        ...
                        <form action="" method="post" className="flex justify-between items-center w-full bg-white dark:bg-slate-900 py-5 px-6 rounded-2xl" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <button className="cursor-pointer text-slate-600 dark:text-gray-200 bg-purple-600 px-5 py-1 float-right rounded-xl flex justify-center items-center" disabled={adding}>
                                {adding ? (
                                    // Loading spinner SVG
